...
cohortDefinitionSet <- CohortGenerator::getCohortDefinitionSet(
  settingsFileName = "inst/cuimc/Cohorts.csv",
  jsonFolder = "inst/cuimc/cohorts",
  sqlFolder = "inst/cuimc/sql/sql_server"
)
...
ParallelLogger::saveSettingsToJson(
  ...
  file.path("inst", "cuimc", "ARPAH_Analysis_Specification.json")
)