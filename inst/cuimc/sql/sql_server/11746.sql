...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (443238,40482801)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (443238,40482801)
  and c.invalid_reason is null
...
WHERE (C.value_as_number >= 8.0000 and C.value_as_number <= 30.0000)
...
WHERE (C.value_as_number >= 64.0000 and C.value_as_number <= 99.0000)
